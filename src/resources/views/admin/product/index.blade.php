    ...
    <div class="table-container">
        ...
        <form class="selection" action="{{ route('admin.product.sort') }}" method="get" enctype="multipart/form-data">
            <select name="sort" id="sort" required>
                ...
                <option value="tag_select">タグ</option>
            ...
            <table class="product_table">
                ...
                @foreach ($products as $product)
                    <tr>
                        ...
                        <td><a href="{{ route('admin.product.show', ['id' => $product->id]) }}"><img
                                    src="/storage/image/edit.png" alt="" class="trash_can"></a></td>
                        <td><a href="{{ route('admin.product.destroy', ['id' => $product->id]) }}"><img
                                    src="/storage/image/trash_can.png" alt="" class="trash_can"></a></td>
                    </tr>
                @endforeach
            </table>
            <table class="product_table product_table_trash none">
                ...
                @foreach ($delete_products as $product)
                    <tr>
                        ...
                        <td><a href="{{ route('admin.product.restore', ['id' => $product->id]) }}"><img
                                    src="/storage/image/restore.png" alt="" class="trash_can"></a></td>
                        <td><a href="{{ route('admin.product.delete', ['id' => $product->id]) }}"><img
                                    src="/storage/image/complete_delete.webp" alt="" class="trash_can"></a></td>
                    </tr>
                @endforeach
            </table>
            {{ $products->links() }}
    ...
    <div class="overlay">
        <form class="modal" action="{{ route('admin.product.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="textField">
                ...
                <img id="preview" class="img-thumbnail h-25 w-25 mb-3" width="600px" height="450px"
                    src="/storage/image/図1.png">
            </div>
            <div class="textField">
                <p>価格</p>
